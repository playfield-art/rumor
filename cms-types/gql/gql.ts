 ...
 */
const documents = {
    "mutation createSession($boothId: ID!, $sessionId: String!, $language: ENUM_SESSION_LANGUAGE!, $moderated: Boolean = false, $answers: [ComponentAnswersAnwserInput!], $narrative: JSON) {\n  createSession(\n    data: {booth: $boothId, session_id: $sessionId, language: $language, moderated: $moderated, narrative: $narrative, answers: $answers}\n  ) {\n    data {\n      id\n    }\n  }\n}": types.CreateSessionDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation createSession($boothId: ID!, $sessionId: String!, $language: ENUM_SESSION_LANGUAGE!, $moderated: Boolean = false, $answers: [ComponentAnswersAnwserInput!], $narrative: JSON) {\n  createSession(\n    data: {booth: $boothId, session_id: $sessionId, language: $language, moderated: $moderated, narrative: $narrative, answers: $answers}\n  ) {\n    data {\n      id\n    }\n  }\n}"): (typeof documents)["mutation createSession($boothId: ID!, $sessionId: String!, $language: ENUM_SESSION_LANGUAGE!, $moderated: Boolean = false, $answers: [ComponentAnswersAnwserInput!], $narrative: JSON) {\n  createSession(\n    data: {booth: $boothId, session_id: $sessionId, language: $language, moderated: $moderated, narrative: $narrative, answers: $answers}\n  ) {\n    data {\n      id\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
